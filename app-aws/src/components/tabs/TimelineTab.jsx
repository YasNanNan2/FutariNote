const TimelineTab = ({ timeline, stampStats, loading }) => {
    const totalStamps = Object.values(stampStats || {}).reduce((a, b) => a + b, 0);
    ...
    return (
        <div style={{ padding: '20px', paddingBottom: '100px' }}>
            ...
            <div style={{
                ...
                <p style={{ margin: '8px 0', fontSize: '48px', fontWeight: 'bold' }}>💝 {totalStamps}</p>
